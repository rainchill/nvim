...
keymap.set({"i", "n", "v"}, "<F12>", "<cmd>lua require'dap'.step_over()<CR>", {silent = true, noremap = true, buffer = bufnr})
...
-- toggleterm
keymap.set({"n", "t"}, "<c-g>", "<Cmd> ToggleTerm<CR>", {noremap = true, silent = true})
